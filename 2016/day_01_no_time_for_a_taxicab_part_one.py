...
Then, follow the provided sequence: either 
...
for i in range(len(input_data)):
    ...
    if orientation == "N":
        if direction == "L":
            starting_coordinates[0] -= distance
            orientation = "W"
        else:
            starting_coordinates[0] += distance
            orientation = "E"
        ...
        if direction == "L":
            starting_coordinates[1] += distance
            orientation = "N"
        else:
            starting_coordinates[1] -= distance
            orientation = "S"
...
print(f"Current Coordinates {starting_coordinates}, Final answer: {answer}")
